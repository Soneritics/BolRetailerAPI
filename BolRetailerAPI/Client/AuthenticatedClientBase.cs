...
public abstract class AuthenticatedClientBase : ClientBase
{
        ...
        object post = null)
    {
        ...
        result.Headers.Accept.Add(new MediaTypeWithQualityHeaderValue("application/vnd.retailer.v10+json"));
    ...
    protected override void ProcessHttpHeaders(HttpResponseMessage httpResponseMessage)
    {
        ...
        if (httpResponseMessage.Headers.Contains("x-ratelimit-remaining"))
        {
            RateLimits = new RateLimits
            {
                ...
                ResetsAt = DateTime.Now.AddSeconds(
                    int.Parse(httpResponseMessage.Headers.GetValues("x-ratelimit-reset").First())),
